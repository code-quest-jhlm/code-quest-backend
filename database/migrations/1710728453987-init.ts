...
export class Init1710728453987 implements MigrationInterface {
    name = 'Init1710728453987'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "draw" ("id" BIGSERIAL NOT NULL, "title" character varying(150) NOT NULL, "description" character varying(350) NOT NULL, "creation_date" date NOT NULL DEFAULT '"2024-03-18T02:20:56.153Z"', "draw_date" date NOT NULL, "state" "public"."draw_state_enum" NOT NULL DEFAULT 'ACTIVO', "id_user" integer NOT NULL, CONSTRAINT "PK_93d305b8405e4b975c54d609dc8" PRIMARY KEY ("id")); COMMENT ON COLUMN "draw"."id" IS 'Clave primaria de la tabla Usuario'; COMMENT ON COLUMN "draw"."title" IS 'Titulo del sorteo'; COMMENT ON COLUMN "draw"."description" IS 'Descripción del sorteo'`);
        ...
        await queryRunner.query(`CREATE TABLE "draw_reward" ("id" SERIAL NOT NULL, "id_reward" integer NOT NULL, "id_draw" bigint NOT NULL, CONSTRAINT "PK_b00fbca94a4b14cd5d4c8358e60" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "draw_reward" ADD CONSTRAINT "FK_ec24950712218f60874daa0b3bc" FOREIGN KEY ("id_draw") REFERENCES "draw"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "draw_reward" ADD CONSTRAINT "FK_a0a3d40e888340cc3a4fa2fb4d7" FOREIGN KEY ("id_reward") REFERENCES "rewards"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "draw_reward" DROP CONSTRAINT "FK_a0a3d40e888340cc3a4fa2fb4d7"`);
        await queryRunner.query(`ALTER TABLE "draw_reward" DROP CONSTRAINT "FK_ec24950712218f60874daa0b3bc"`);
