...
export class Init1710722905972 implements MigrationInterface {
    name = 'Init1710722905972'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "draw" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(150) NOT NULL, "description" character varying(350) NOT NULL, "creation_date" date NOT NULL DEFAULT '"2024-03-18T00:48:27.905Z"', "draw_date" date NOT NULL, "state" "public"."draw_state_enum" NOT NULL DEFAULT 'ACTIVO', "idUserId" uuid, CONSTRAINT "PK_93d305b8405e4b975c54d609dc8" PRIMARY KEY ("id")); COMMENT ON COLUMN "draw"."title" IS 'Titulo del sorteo'; COMMENT ON COLUMN "draw"."description" IS 'Descripción del sorteo'`);
        ...
        await queryRunner.query(`ALTER TABLE "draw" ADD CONSTRAINT "FK_6837c6b10927e5655d72f0b5a1d" FOREIGN KEY ("idUserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "draw" DROP CONSTRAINT "FK_6837c6b10927e5655d72f0b5a1d"`);
