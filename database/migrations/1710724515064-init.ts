...
export class Init1710724515064 implements MigrationInterface {
    name = 'Init1710724515064'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_role_enum" AS ENUM('user', 'admin')`);
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "userId" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "role" "public"."user_role_enum" NOT NULL DEFAULT 'user', "deletedAt" TIMESTAMP, CONSTRAINT "UQ_d72ea127f30e21753c9e229891e" UNIQUE ("userId"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."draw_state_enum" AS ENUM('ACTIVO', 'INACTIVO')`);
        await queryRunner.query(`CREATE TABLE "draw" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(150) NOT NULL, "description" character varying(350) NOT NULL, "creation_date" date NOT NULL DEFAULT '"2024-03-18T01:15:16.920Z"', "draw_date" date NOT NULL, "state" "public"."draw_state_enum" NOT NULL DEFAULT 'ACTIVO', "id_user" character varying NOT NULL, "userId" uuid, CONSTRAINT "PK_93d305b8405e4b975c54d609dc8" PRIMARY KEY ("id")); COMMENT ON COLUMN "draw"."title" IS 'Titulo del sorteo'; COMMENT ON COLUMN "draw"."description" IS 'Descripción del sorteo'`);
        await queryRunner.query(`CREATE TABLE "participants" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "full_name" character varying(255) NOT NULL, "id_discord" bigint NOT NULL, "idDrawId" uuid, CONSTRAINT "PK_1cda06c31eec1c95b3365a0283f" PRIMARY KEY ("id")); COMMENT ON COLUMN "participants"."full_name" IS 'Nombre del participante'`);
        await queryRunner.query(`CREATE TABLE "rewards" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, CONSTRAINT "PK_3d947441a48debeb9b7366f8b8c" PRIMARY KEY ("id")); COMMENT ON COLUMN "rewards"."name" IS 'Nombre del premio'`);
        await queryRunner.query(`CREATE TABLE "winners" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "id_discord" bigint NOT NULL, "idDrawId" uuid, "idRewardId" uuid, CONSTRAINT "PK_45701ddf409cead5c6e92a12ce8" PRIMARY KEY ("id")); COMMENT ON COLUMN "winners"."id_discord" IS 'Id de discord del participante ganador'`);
        await queryRunner.query(`CREATE TABLE "draw_reward" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "idDrawId" uuid, "idRewardId" uuid, CONSTRAINT "PK_b00fbca94a4b14cd5d4c8358e60" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "draw" ADD CONSTRAINT "FK_9453a62c16daaaf037e792a0ad8" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "draw" DROP CONSTRAINT "FK_9453a62c16daaaf037e792a0ad8"`);
